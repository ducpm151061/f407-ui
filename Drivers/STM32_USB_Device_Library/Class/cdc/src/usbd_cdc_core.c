  ...
  case USB_REQ_TYPE_CLASS :
      ...
      if (req->wLength)
      {
        ...
        if (req->bmRequest & 0x80)
        {
          ...
          CDC_FOPS.pIf_Ctrl(req->bRequest, CmdBuff, req->wLength);
      ...
      else /* No Data request */
      {
        ...
        CDC_FOPS.pIf_Ctrl(req->bRequest, NULL, 0);
      }
...
{ 
  ...
  {
    /* Process the data */
    CDC_FOPS.pIf_Ctrl(cdcCmd, CmdBuff, cdcLen);
...
{      
  ...
  CDC_FOPS.pIf_DataRx(USB_Rx_Buffer, USB_Rx_Cnt);

...
u8 mem2base[MEM2_MAX_SIZE] __attribute__((section("malloc"))) __attribute__((aligned(32)));
// u8 mem3base[MEM3_MAX_SIZE] __attribute__((at(0X10000000))) __attribute__((aligned(32)));
u8 mem3base[MEM3_MAX_SIZE] __attribute__((section(".ccmram"))) __attribute__((aligned(32)));
...
u16 mem3mapbase[MEM3_ALLOC_TABLE_SIZE] __attribute__((section(".ccmram"))) __attribute__((aligned(32)));

...
// static uint16_t CDC_COMConfig(uint8_t Conf);

CDC_IF_Prop_TypeDef CDC_FOPS = {CDC_Init, CDC_DeInit, CDC_Ctrl, CDC_DataTx, CDC_DataRx};
 ...
 * @param  Len: Number of data to be sent (in bytes)
 * @retval Result of the opeartion: USBD_OK if all operations are OK else CDC_FAIL
 */

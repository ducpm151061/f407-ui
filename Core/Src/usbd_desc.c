...
#define USBD_VID 0x0405
#define USBD_PID 0x1997

#define USBD_LANGID_STRING 0x409
#define USBD_MANUFACTURER_STRING "STM32F407"

#define USBD_PRODUCT_HS_STRING "Board F4 in HS Mode"

#define USBD_SERIALNUMBER_HS_STRING "00000000001A"
#define USBD_PRODUCT_FS_STRING "STM32F407 CDC"
...
USBD_DEVICE USR_desc = {
    USBD_USR_DeviceDescriptor,       USBD_USR_LangIDStrDescriptor, USBD_USR_ManufacturerStrDescriptor,
    USBD_USR_ProductStrDescriptor,   USBD_USR_SerialStrDescriptor, USBD_USR_ConfigStrDescriptor,

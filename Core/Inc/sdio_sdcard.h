...
#define SD_CMD_SD_ERASE_GRP_START                                                                                      \
    ((u8)32) /*!< To set the address of the first write                                                                \
                   block to be erased. (For SD card only) */
#define SD_CMD_SD_ERASE_GRP_END                                                                                        \
    ((u8)33) /*!< To set the address of the last write block of the                                                    \
                   continuous range to be erased. (For SD card only) */
#define SD_CMD_ERASE_GRP_START                                                                                         \
    ((u8)35) /*!< To set the address of the first write block to be erased.                                            \
                   (For MMC card only spec 3.31) */

#define SD_CMD_ERASE_GRP_END                                                                                           \
    ((u8)36) /*!< To set the address of the last write block of the                                                    \
